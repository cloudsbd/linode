import{kx as j,e as L,u as w,r as l,cx as A,j as e,hh as T,aa as x,C as S,T as h,a3 as k,cQ as E,ag as M}from"./index-Eksrs3uK.js";import{L as C}from"./LandingHeader-JXAVBhqg.js";import{b as B,c as F}from"./betas-xsGya32U.js";const I=j(),H=I,U=()=>{var c;const p=`# Early Adopter Testing Program
...
`,t=L(),o=w(),a=(c=t==null?void 0:t.state)==null?void 0:c.betaId,{data:i,isError:m,isLoading:n}=B(a),[r,u]=l.useState(!1),[y,s]=l.useState(!1),{mutateAsync:g}=F(),{enqueueSnackbar:b}=A(),f=async P=>{var d;s(!0);try{await g({id:P}),o.push("/betas")}catch(v){b((d=v[0])==null?void 0:d.reason,{autoHideDuration:1e4,variant:"error"}),s(!1)}};return a===void 0||m||i===void 0&&!n?e.jsx(T,{}):e.jsxs(e.Fragment,{children:[e.jsx(C,{title:"Sign Up"}),e.jsx(x,{children:n?e.jsx(S,{}):e.jsxs(H,{children:[e.jsx(h,{paddingBottom:2,variant:"h2",children:i.label}),e.jsx(h,{paddingBottom:2,children:i.description}),e.jsx(k,{language:"plaintext",sanitizeOptions:{},textOrMarkdown:p}),e.jsx(E,{onChange:()=>{u(!r)},text:"I agree to the terms",value:r}),e.jsx(M,{primaryButtonProps:{"data-testid":"submit",disabled:!r,label:"Sign Up",loading:y,onClick:()=>{f(a)}},secondaryButtonProps:{"data-testid":"cancel",label:"Cancel",onClick:()=>{o.push("/betas")}}})]})})]})};export{U as default};
